...
if(NOT "/home/vuhoang/robot_sensors/devel/include" STREQUAL "")
  set(feel_INCLUDE_DIRS "")
  set(_include_dirs "/home/vuhoang/robot_sensors/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'feel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vuhoang/robot_sensors/src/feel/${idir}'.  Ask the maintainer 'vuhoang <vuhoang@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vuhoang/robot_sensors/devel/lib;/opt/ros/hydro/lib)
