...
if("TRUE" STREQUAL "TRUE")
  set(feel_SOURCE_PREFIX /home/vuhoang/tem_hum_sensor/src/feel)
  set(feel_DEVEL_PREFIX /home/vuhoang/tem_hum_sensor/devel)
  set(feel_INSTALL_PREFIX "")
  set(feel_PREFIX ${feel_DEVEL_PREFIX})
else()
  set(feel_SOURCE_PREFIX "")
  set(feel_DEVEL_PREFIX "")
  set(feel_INSTALL_PREFIX /home/vuhoang/tem_hum_sensor/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'feel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vuhoang/tem_hum_sensor/src/feel/${idir}'.  Ask the maintainer 'vuhoang <vuhoang@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vuhoang/tem_hum_sensor/devel/lib;/opt/ros/hydro/lib)
