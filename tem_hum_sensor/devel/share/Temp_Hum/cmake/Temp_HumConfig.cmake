...
if(NOT "/home/vuhoang/tem_hum_sensor/devel/include" STREQUAL "")
  set(Temp_Hum_INCLUDE_DIRS "")
  set(_include_dirs "/home/vuhoang/tem_hum_sensor/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'Temp_Hum' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vuhoang/tem_hum_sensor/src/temp_hum/${idir}'.  Ask the maintainer 'vuhoang <vuhoang@todo.todo>' to fix it.")
    endif()
